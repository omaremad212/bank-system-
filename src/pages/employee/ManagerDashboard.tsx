    ...
    <div>
      ...
      <div className="table-card">
        ...
        <div style={{ padding: '1.5rem', display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
          ...
          <Link to="/employee/employees" className="btn btn-primary">
            <span>&#x1F468;&#x200D;&#x1F4BB;</span> Manage Employees
          </Link>
          <Link to="/employee/loans" className="btn btn-success">
            <span>&#x1F3E2;</span> Approve Loans
          </Link>
          <Link to="/employee/transactions" className="btn btn-secondary">
            <span>&#x1F4B0;</span> View Transactions
          </Link>
          <Link to="/employee/branches" className="btn btn-secondary">
